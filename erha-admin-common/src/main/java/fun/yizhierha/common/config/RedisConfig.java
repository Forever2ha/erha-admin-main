...
public class RedisConfig extends CachingConfigurerSupport {
    ...
    public RedisTemplate<Object, Object> redisTemplate(RedisConnectionFactory redisConnectionFactory) {
        ...
        ParserConfig.getGlobalInstance().addAccept("fun.yizhierha.domain");
        ParserConfig.getGlobalInstance().addAccept("fun.yizhierha.service.dto");
        // 模块内的实体类
        ParserConfig.getGlobalInstance().addAccept("fun.yizhierha.modules.mnt.domain");
        ParserConfig.getGlobalInstance().addAccept("fun.yizhierha.quartz.domain");
        ParserConfig.getGlobalInstance().addAccept("fun.yizhierha.modules.system.domain");
        // 模块内的 Dto
        ParserConfig.getGlobalInstance().addAccept("fun.yizhierha.modules.mnt.service.dto");
