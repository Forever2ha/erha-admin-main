...
public class OraProjectServiceImpl extends ServiceImpl<OraProjectMapper, OraProject> implements OraProjectService{
    ...
    public PageUtils<OraProject> list(RetrieveOraProjectVo retrieveOraProjectVo, Query.PageVo pageVo) {
        ...
        String pname = retrieveOraProjectVo.getPname();
        String createBy = retrieveOraProjectVo.getCreateBy();
        Boolean enabled = retrieveOraProjectVo.getEnabled();

        if (pname != null){
            wrapper.like(OraProject.COL_PNAME,pname);
        }
        if (createBy != null){
            wrapper.like(OraProject.COL_CREATE_BY,createBy);
        }
        if (enabled != null){
