...
<div style="height: auto;
  ...
  font-size: 12px">
        ...
        <div style="text-align: center;
            ...
            Copyright &copy;${.now?string("yyyy")} <a hover="color: #DA251D;" style="color: #999;" href="https://github.com/Forever2ha/erha-admin-main" target="_blank">EH-ADMIN</a> 后台管理系统 All Rights Reserved.
        </div>
